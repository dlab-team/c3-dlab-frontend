      ...
      <Form>
        <Form.Group widths="equal">
          ...
          <Form.Field required>
            ...
            <Form.Input placeholder="Apellido" name="LastName" />
          </Form.Field>
        </Form.Group>
        <Form.Group widths="equal">
          <Form.Field required>
          ...
          <Form.Field required>
            ...
            <Form.Input placeholder="Numero de teléfono" />
          </Form.Field>
        </Form.Group>
        <Form.Group widths="equal">
          <Form.Field required>
        ...
        <p>
          A continuación, carreras profesionales, cursos, bootcamp o
          certificaciones cursadas relacionadas al desarrollo de software,
          diseño o TI (puedes indicarnos las más importantes o actuales):
        </p>
        <Form.Group widths="equal">
          <Form.Field required>
            <Form.Input
        ...
        <Header as="h3">
          Indícanos tus conocimientos a Nivel 2 (Tengo poca experiencia laboral,
          menos de dos años, necesito supervisión constante):
        </Header>
        <Form.Field>
          <label>Lenguaje nivel 2</label>
        </Form.Field>
        <Lenguage></Lenguage>
        <Form.Field label="Bases o Frameworks nivel 2"></Form.Field>
        <Frameworks></Frameworks>
        <Form.Field>
